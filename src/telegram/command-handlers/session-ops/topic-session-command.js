...
function buildUnknownSessionCommandMessage(
  ...
  if (isEnglish(language)) {
    return "Available commands: /help, /guide, /clear, /new, /hosts, /host, /zoo, /status, /limits, /global, /menu, /language, /q (/кю), /wait, /suffix, /model, /reasoning, /interrupt, /diff, /goal, /compact, and /purge.";
  }

  return "Сейчас доступны /help, /guide, /clear, /new, /hosts, /host, /zoo, /status, /limits, /global, /menu, /language, /q (/кю), /wait, /suffix, /model, /reasoning, /interrupt, /diff, /goal, /compact и /purge.";
}
